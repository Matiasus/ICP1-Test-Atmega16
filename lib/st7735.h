...
#define __ST7735_H__
  ...
  #ifndef ST7735_PORT
    #define ST7735_PORT   SPI_PORT
  #endif
  #ifndef ST7735_DDR
    #define ST7735_DDR    SPI_DDR
  #endif
  #ifndef ST7735_DC_LD
  ...
  #endif
  #ifndef ST7735_CS_LD
    #define ST7735_CS_LD  SPI_SS
  #endif
  #ifndef ST7735_MOSI
    #define ST7735_MOSI   SPI_MOSI
  #endif
  #ifndef ST7735_MISO
    #define ST7735_MISO   SPI_MISO
  #endif
  #ifndef ST7735_SCK
    #define ST7735_SCK    SPI_SCK
  #endif

  #ifndef ST7735_HWRST_DDR
    #define ST7735_HWRST_DDR  ST7735_DDR
  #endif
  #ifndef ST7735_HWRST_PORT
    #define ST7735_HWRST_PORT ST7735_PORT
  #endif
  #ifndef ST7735_HWRST_PIN
    #define ST7735_HWRST_PIN  0
  #endif
